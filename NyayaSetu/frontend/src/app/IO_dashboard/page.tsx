...
const RegisterCasePage = dynamic(() => import("./new_case"));
...
export default function InvestigationOfficerDashboard() {
    ...
    try {
        ...
        if (decodedToken.exp && decodedToken.exp < currentTime) {
            ...
            decodedToken.role &&
            decodedToken.role.toLowerCase().replace(/[\s_]/g, "") === "investigatingofficer"
        ) {
            ...
            setIsAuthorized(false);
            setError("Unauthorized: Not an Investigation Officer.");
        ...
        <div className="flex flex-col min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
            ...
            <div className="flex flex-grow">
                ...
                <main className="flex-grow p-6 overflow-auto">
                    ...
                    {activeTab === "Register New Case" && <RegisterCasePage />}
